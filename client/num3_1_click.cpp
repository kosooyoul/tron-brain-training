...
void num3_1_click(WSCbase* object){
  //do something...
  int temp;
  ...
  switch(temp){
	...
	card0->setProperty(WSNlabelString,"1");break;
    case 1:
	card1->setProperty(WSNuserValue,1);
	card1->setProperty(WSNlabelString,"1");break;
    case 2:
	card2->setProperty(WSNuserValue,1);
	card2->setProperty(WSNlabelString,"1");break;
    case 3:
	card3->setProperty(WSNuserValue,1);
	card3->setProperty(WSNlabelString,"1");break;
    case 4:
	card4->setProperty(WSNuserValue,1);
	card4->setProperty(WSNlabelString,"1");break;
    case 5:
	card5->setProperty(WSNuserValue,1);
	card5->setProperty(WSNlabelString,"1");break;
    case 6:
	card6->setProperty(WSNuserValue,1);
	card6->setProperty(WSNlabelString,"1");break;
    case 7:
	card7->setProperty(WSNuserValue,1);
	card7->setProperty(WSNlabelString,"1");break;
    case 8:
	card8->setProperty(WSNuserValue,1);
	card8->setProperty(WSNlabelString,"1");break;
    case 9:
	card9->setProperty(WSNuserValue,1);
	card9->setProperty(WSNlabelString,"1");break;
  }
  temp++;
  if(temp > 10) temp = 10;
  inputpoint->setProperty(WSNuserValue, temp);
}
static WSCfunctionRegister  op("num3_1_click",(void*)num3_1_click);
