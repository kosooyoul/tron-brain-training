...
function send_mail( $get, $send, $name, $title, $body, $html ) {
    ...
    $tt = "두뇌 트레이닝 게임에 등록하셨음을 알려드립니다.";	//제목
    $ht = "1";										//(1:사용, 0:사용안함)
...
$body	.= $nm."(".$id.")</font></b><font face='돋움'> 님 가입을 환영합니다.<br><br>";
$body	.= "본 게임은 테스트입니다.<br>문의 사항은 http://www.ahyane.net로 해주시기 바랍니다.<br></font></span></p></td><td width='40' height='150' style='border-top-width:1; border-bottom-width:1; border-top-color:rgb(239,101,49); border-bottom-color:rgb(239,101,49); border-top-style:dashed; border-bottom-style:dashed;'>&nbsp;</td></tr><tr><td width='40' height='40'>&nbsp;</td><td width='398' style='border-right-width:1; border-left-width:1; border-right-color:rgb(239,101,49); border-left-color:rgb(239,101,49); border-right-style:dashed; border-left-style:dashed;' height='40'>&nbsp;</td><td width='40' height='40'>&nbsp;</td></tr></table>";
