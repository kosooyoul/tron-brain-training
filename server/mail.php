...
function send_mail( $get, $send, $name, $title, $body, $html ) {
    ...
    $tt = "트레이닝 정보관리서버에서 비밀번호를 알려드립니다.";				//제목
    $ht = "1";										//(1:사용, 0:사용안함)
...
$body	.= $nm."(".$id.")</font></b><font face='돋움'> 님의 <b>비밀번호</b>는<br><br></font></span><b><span style='font-size:10pt; background-color:yellow;'><font face='돋움' color='red'>";
$body	.= $pw."</font></span></b><span style='font-size:10pt;'><font face='돋움'><br><br>입니다. 감사합니다. ^^</font></span></p></td><td width='40' height='150' style='border-top-width:1; border-bottom-width:1; border-top-color:rgb(239,101,49); border-bottom-color:rgb(239,101,49); border-top-style:dashed; border-bottom-style:dashed;'>&nbsp;</td></tr><tr><td width='40' height='40'>&nbsp;</td><td width='398' style='border-right-width:1; border-left-width:1; border-right-color:rgb(239,101,49); border-left-color:rgb(239,101,49); border-right-style:dashed; border-left-style:dashed;' height='40'>&nbsp;</td><td width='40' height='40'>&nbsp;</td></tr></table>";
...
흠냥... -ㅅ-<br>
형식<br>
http://www.ahyane.net/@mail/mail.php<br>
